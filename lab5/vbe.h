...
typedef struct {
	...
	//Added for VBE 2.0
	uint16_t OemSoftwareRev; //VBE implementationSoftware
	phys_bytes revisionOemVendorNamePtr; //Pointer to VendorName
	phys_bytes StringOemProductNamePtr; //Pointer to Product Name
	phys_bytes StringOemProductRevPtr; //Pointer to ProductRevision String
